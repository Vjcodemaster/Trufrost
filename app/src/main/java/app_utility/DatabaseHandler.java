...
public class DatabaseHandler extends SQLiteOpenHelper {
    ...
    private static final String KEY_SUB_CATEGORY_IMAGES_PATH = "KEY_SUB_CATEGORY_IMAGES_PATH";
    ...
    private static final String KEY_INDIVIDUAL_PRODUCT_TAGS = "KEY_INDIVIDUAL_PRODUCT_TAGS";

    private static final String KEY_FIRST_SUB_CATEGORY_NAMES = "KEY_FIRST_SUB_CATEGORY_NAMES";

    private static final String KEY_FIRST_SUB_CATEGORY_IMAGES_LINK = "KEY_FIRST_SUB_CATEGORY_IMAGES_LINK";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String CREATE_INDIVIDUAL_PRODUCTS = "CREATE TABLE " + TABLE_INDIVIDUAL_PRODUCTS + "("
                ...
                + KEY_INDIVIDUAL_PRODUCT_TAGS + " TEXT)";
    ...
    public void addDataToIndividualProducts(DataBaseHelper dataBaseHelper) {
        ...
        values.put(KEY_INDIVIDUAL_PRODUCT_TAGS, dataBaseHelper.get_individual_product_tags());
    ...
    public List<DataBaseHelper> getAllSubProducts() {
        List<DataBaseHelper> dataBaseHelperList = new ArrayList<>();
        // Select All Query
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                dataBaseHelper.set_sub_category_images_link(cursor.getString(5));
                dataBaseHelper.set_sub_category_images_path(cursor.getString(6));
                //dataBaseHelper.set_individual_product_description(cursor.getString(5));
                //dataBaseHelper.set_individual_product_images_path(cursor.getString(6));
                // Adding data to list
                dataBaseHelperList.add(dataBaseHelper);
    ...
    public List<DataBaseHelper> getSubCategoryUsingFirstSC(String sKey) {
        ...
        if (cursor.moveToFirst()) {
            do {
                ...
                dataBaseHelper.set_sub_category_images_path(cursor.getString(1));
                // Adding data to list
                dataBaseHelperList.add(dataBaseHelper);
