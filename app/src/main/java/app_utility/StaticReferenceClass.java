...
public class StaticReferenceClass {
    ...
    public static final String sURL = "http://166.62.125.168:8040/api/";//"http://166.62.125.168:8040/api/";//"http://192.168.1.15:8040/api/";//"http://192.168.43.190:7000/api/";//"http://173.82.114.197:9000/api/";//"http://192.168.1.4//
    public static final String SERVER_URL = "166.62.125.168";//"192.168.43.190";//

    public static final int PORT_NO = 8040;//7000;//
