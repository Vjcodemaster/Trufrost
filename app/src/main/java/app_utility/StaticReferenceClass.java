...
public class StaticReferenceClass {
    ...
    public static final String sURL = "http://13.233.198.95:9010/api/";//"https://trufrost.odoo.com/api/";//"http://13.233.198.95:9010/api/";//"https://demotrufrost.odoo.com/api/";//"http://192.168.1.34:8069/api/";//"http://166.62.125.168:8040/api/";//"http://166.62.125.168:8040/api/";//"http://192.168.1.15:8040/api/";//"http://192.168.43.190:7000/api/";//"http://173.82.114.197:9000/api/";//"http://192.168.1.4//"http://192.168.1.43:8069/api/";//
    public static final String SERVER_URL = "13.233.198.95";//"trufrost.odoo.com";//"https://demotrufrost.odoo.com";//"166.62.125.168";//"192.168.43.190";//"http://192.168.1.43:8069";//
